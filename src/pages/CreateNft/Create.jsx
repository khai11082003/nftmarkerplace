...
export default function Create() {
    ...
    const uploadToIPFS = async () => {
      ...
      try {
        ...
        console.log(res);
        setUriImage(`https://aquamarine-obliged-nightingale-796.mypinata.cloud/ipfs/${res.data.IpfsHash}`);
      } catch (error) {
        console.error(error);
      }
    };
  ...
  const contractAddress = '0x707a801CB50d0496873CFaA16B58C66951DC3386';
  ...
  useEffect(() => {
    const initWeb3 = async () => {
      if (window.ethereum) {
        ...
        console.error('Trình duyệt của bạn không hỗ trợ Web3. Hãy thử một trình duyệt khác.');
      }
  ...
  const mint = async () => {
    try {
      const result = await contract.methods.mintNftToken('https://aquamarine-obliged-nightingale-796.mypinata.cloud/ipfs/Qmbg3nLyXJrjoxLgYVB2mVJhpz8UhRtEHmY1V1RuixPgQW').send({ from: account })
      ...
      .on('confirmation', function(confirmationNumber, receipt){
        ...
        console.log('Giao dịch được xác nhận, confirmationNumber:', confirmationNumber, 'receipt:', receipt);
      })
            ...
            <div className="box1" style={{width: "50%"}}>
                ...
                <div className="box1--main">
                    <form onSubmit={handleSubmit}>
                        <div className="box">
                            <div className="button-1" onClick={uploadToIPFS}>Upload Image</div>
                            <input type="file" onChange={changeHandler}/>
                        </div>
                        <div className="box">
                        ...
                        <div className="button-1">NFT Information</div>
                            <textarea name="" id="" cols="58" rows="15" onChange={handledesc}></textarea>
                        </div>
