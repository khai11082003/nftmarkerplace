    ...
    return (
        <header>
            ...
            <div className="Bottom__header container">
                <div className="Bottom sub__container">
                 <div className='inner__logo'>   <div className="logo">
                        ...
                        <Link className="brand" to = "/">FIDEC</Link></div>
           
                        <div className="icon__bar hidden">             <div class="mobile_only_icon_group account hidden">
<a href="https://enefti.modeltheme.com/my-account/">
<i class="fa fa-user-circle"></i>
</a>
</div><i class="fa-solid fa-bars" onClick={() => setActive(!active)}></i></div>
                    </div>
                   <div className="list__item--sign">
                   <div className={`list__item ${active ? "active" : null}`} >
                        <ul style={{
                        display: "flex",
                    ...
                    <div className='sign__in'>
                        <i className="fa fa-search" style={{color: "blue",fontSize: "16px", marginRight: "5px"}}></i>
                        <Link to="/" style={{
                            fontSize: "18px"
                        }}>Sign In</Link>
                    </div>
